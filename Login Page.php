...
<body>
    <div class="main">
        ...
        <form action="process.php" method="post" onsubmit="return validation()"  value="Reset form">
        <!-- <form method="post" action="process.php"  value="Reset form"> -->
            <div>
...
<script>
        function validation() {
            ...
            if ((pass.length <= 4) || (pass.length > 20)) {
                document.getElementById('password').innerHTML = "**password  length must be between 4 and 20";
                return false;
            } else {
